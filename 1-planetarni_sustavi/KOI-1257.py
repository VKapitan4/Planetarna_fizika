...
p1 = universe.Planet(m_1, "KOI-1257")
p2 = universe.Planet(m_2, "KOI-1257 b")
...
numericki_period_1 = svemir.animate_plot(10000, 5*T, 10)
...
numericki_period_2 = svemir.animate_plot(10000, 5*T, 10)
