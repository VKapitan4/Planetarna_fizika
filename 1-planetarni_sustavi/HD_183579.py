...
m_1 = m_sun * 1.031
m_2 = m_jupiter * 0.0302
semi_major_axis = au * 0.1334
T = day * 17.471278
e = 0.28
...
p1 = universe.Planet(m_1, "HD 183579")
p2 = universe.Planet(m_2, "HD 183579 b")
...
numericki_period_2 = svemir.animate_plot(5000, 5*T, 10)
